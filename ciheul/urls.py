...
urlpatterns = patterns('',
    ...
    url(r'^home/about', 'home.views.about'),
    url(r'^home/jobs', 'home.views.jobs'),
    #url(r'^home/team', 'home.views.team'),
    #url(r'^home/services', 'home.views.services'),
    #url(r'^home/portfolio', 'home.views.portfolio'),
    url(r'^home/contact', 'home.views.contact'),
